(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@ionic/angular'), require('@ionic/Storage'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('broker-lib', ['exports', '@angular/core', '@angular/common/http', '@ionic/angular', '@ionic/Storage', 'rxjs'], factory) :
    (global = global || self, factory(global['broker-lib'] = {}, global.ng.core, global.ng.common.http, global.angular, global.Storage, global.rxjs));
}(this, (function (exports, core, http, angular, Storage, rxjs) { 'use strict';
